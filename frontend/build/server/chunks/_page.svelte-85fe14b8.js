import { c as create_ssr_component, a as subscribe, e as escape } from './index3-3b5a9ccf.js';
import { formatDistanceToNow, format } from 'date-fns';
import de from 'date-fns/locale/de/index.js';
import { t as time } from './time-03c2953a.js';
import './index2-584cecbe.js';
  ...
  return `<div class="container-fluid m-0 p-1 vh-100 d-flex flex-column"><div class="row"><div class="col-auto"><h1>Modem</h1></div>
	...
	<div class="row overflow-auto"><div class="col">${status ? `<table class="table table-sm"><colgroup><col>
					...
					<tbody><tr><td>Connected</td>
						...
						<tr><td>Cached</td>
							<td colspan="2">${status.cached ? `<i class="icofont-check"></i>` : `<i class="icofont-close"></i>`}</td></tr>
						<tr><td>Operator</td>
...
//# sourceMappingURL=_page.svelte-85fe14b8.js.map
