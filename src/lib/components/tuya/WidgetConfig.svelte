<script lang="ts">
	...
	import { TUYA_SERVICE_TYPE, type TuyaWidgetConfig } from '$lib/models/tuya';

	export let name: string;
	export let config: TuyaWidgetConfig;
	export let services: ServiceInstance[];

	$: validServices = services.filter((s) => s.type === TUYA_SERVICE_TYPE);
</script>
