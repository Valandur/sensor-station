...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="h-100 d-flex flex-column justify-content-end">${departures.length > 0 ? `${each(departures, (departure) => {
    return `<div class="row fs-2"><div class="col-3">${escape(formatInTimeZone(departure.scheduled, data.tz, "HH:mm", { locale: de }))} ${departure.delay > 0 ? `<span class="text-red">+${escape(departure.delay)}</span>` : ``}</div> <div class="col-2">${escape(departure.lineName)}</div> <div class="col-6">${escape(departure.destination)}</div> </div>`;
...
//# sourceMappingURL=_page.svelte-B63MHojP.js.map
