...
const css = {
  code: "html,body{overflow:hidden;overscroll-behavior:none}.time-main.svelte-1hoyhum{font-size:5rem;line-height:4rem;font-weight:600;color:var(--bs-white)}.time-seconds.svelte-1hoyhum{font-size:1.8rem;line-height:1.6rem}.icons.svelte-1hoyhum{font-size:0.6rem}.progress.svelte-1hoyhum{position:fixed;left:0;bottom:0;height:2px}.loading.svelte-1hoyhum{position:fixed;bottom:10px;right:16px;z-index:1000;animation:svelte-1hoyhum-rotating 2s linear infinite}@keyframes svelte-1hoyhum-rotating{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container-fluid vh-100 d-flex flex-column"><div class="row flex-nowrap mb-2 p-1"><div class="col-auto d-flex flex-row align-items-end mt-1 p-0"><div class="time-main svelte-1hoyhum">${escape(timeStr)}</div>
			<div class="time-seconds ms-1 svelte-1hoyhum">${escape(secondStr)}</div></div>

		<div class="col d-flex flex-column justify-content-end align-items-end overflow-hidden p-0"><div class="row icons flex-nowrap svelte-1hoyhum">${modemStatus?.operator ? `<div class="col-auto"><i class="icofont-globe"></i>
...
<div class="progress bg-secondary svelte-1hoyhum"${add_styles({ "width": $progress + "%" })}></div>

${$navigating ? `<div class="loading svelte-1hoyhum"><i class="icofont-spinner"></i></div>` : ``}`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-b85b6395.js.map
