import { c as create_ssr_component, k as add_attribute, j as each, e as escape, v as validate_component } from './index3-00641961.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="h-100 d-flex flex-column justify-content-end">${upload ? `<div class="${["row align-items-end", upload.ratio < 1 ? "h-100" : ""].join(" ").trim()}"><div class="${[
    ...
    return `${escape(line)}
				...
				<div class="row"><div class="rol">${escape(format(upload.ts, "dd. MMM yyyy", { locale: de }))}</div></div></div></div>` : `${validate_component(EmptyCard, "EmptyCard").$$render($$result, {}, {}, {
    default: () => {
...
//# sourceMappingURL=_page.svelte-cc8274f6.js.map
