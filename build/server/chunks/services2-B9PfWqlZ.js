...
const ServiceConfig$7 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}</tbody></table></div></div> <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalWifi" data-svelte-h="svelte-q33xok">Launch demo modal</button> <div class="modal fade" id="modalWifi" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" data-svelte-h="svelte-1bkb75o"><h5 class="modal-title">Connect to Wifi</h5> <button type="button" class="btn-close" data-bs-dismiss="modal"></button></div> <div class="modal-body"><form method="POST"><input type="hidden" name="name"${add_attribute("value", name, 0)}> <input type="hidden" name="action" value="connect"> <input type="hidden" name="ssid"${add_attribute("value", selectedSSID, 0)}> <input type="password" name="password" placeholder="Password"> <button type="submit" class="btn btn-primary" data-svelte-h="svelte-1417ff7"><i class="fa-solid fa-link"></i></button></form></div> <div class="modal-footer" data-svelte-h="svelte-1swkfec"><button type="button" class="btn btn-default" data-bs-dismiss="modal">Close</button> <button type="button" class="btn btn-theme">Connect</button></div></div></div></div>`;
});
...
//# sourceMappingURL=services2-B9PfWqlZ.js.map
