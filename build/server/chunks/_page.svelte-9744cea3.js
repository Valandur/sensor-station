import { c as create_ssr_component, e as escape, d as each, k as add_attribute } from './index3-53157c6f.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="h-100 d-flex flex-column justify-content-end"><div class="row d-flex flex-row justify-content-end"><div class="col-auto text-muted"><i class="icofont-location-pin"></i>
    ...
    return `<div class="col d-flex flex-column justify-content-between align-items-center"><div class="text svelte-njznxm">${escape(format(forecast.ts, "iiiiii", { locale: de }))}</div>
...
//# sourceMappingURL=_page.svelte-9744cea3.js.map
