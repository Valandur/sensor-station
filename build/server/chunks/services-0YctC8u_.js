...
const BATTERY_SERVICE_ACTIONS = ["main", "preview", "config"];
...
const MODEM_SERVICE_ACTIONS = ["main", "preview", "config"];
...
const NETWORK_SERVICE_ACTIONS = ["preview"];
...
class CarouselService extends BaseService {
  ...
  async getConfig(_) {
    ...
    return {
      ...
      type: "config",
      config: this.config,
      services: servicesService.getInstances()
    };
  }
  async setConfig({ form }) {
...
//# sourceMappingURL=services-0YctC8u_.js.map
