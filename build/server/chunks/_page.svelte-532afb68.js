import { c as create_ssr_component, a as subscribe, d as each, k as add_attribute, e as escape } from './index3-53157c6f.js';
import { formatDistanceToNow } from 'date-fns';
import de from 'date-fns/locale/de/index.js';
import { p as paused } from './screen-eedcf832.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="h-100 d-flex flex-column">${``}
	...
	${each(items, (item) => {
    return `<div class="row mt-1 flex-1"><div class="col-3 me-1 image svelte-ntqhrj"><img alt="Thumbnail"${add_attribute("src", `/data/news/${item.image}`, 0)} class="svelte-ntqhrj"></div>
			<div class="col abstract d-flex flex-column justify-content-around svelte-ntqhrj"><div class="fs-4">${escape(item.title)}</div>
				<div class="fs-6 text-muted">${escape(formatDistanceToNow(item.ts, { locale: de, addSuffix: true }))}
				</div></div>
		</div>`;
  })}
</div>`;
...
//# sourceMappingURL=_page.svelte-532afb68.js.map
