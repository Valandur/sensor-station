...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container-fluid vh-100 d-flex flex-column"><div class="row flex-nowrap mb-2 p-1"><div class="col-auto d-flex flex-row align-items-end mt-1 p-0"><div class="time-main svelte-iy2ci2">${escape(timeStr)}</div>
		...
		<div class="col d-flex flex-column justify-content-end align-items-end p-0"><div class="row icons flex-nowrap justify-content-end svelte-iy2ci2">${modemStatus?.operator ? `<div class="col-auto"><i class="icofont-globe"></i>
...
//# sourceMappingURL=_layout.svelte-da12529d.js.map
