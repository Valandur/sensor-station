...
import { p as paused } from './screen-76c56fae.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="h-100 d-flex flex-column">${``}
    ...
    return `<div class="row mt-1 flex-1"><div class="col-3 me-1 image svelte-ntqhrj"><img alt="Thumbnail"${add_attribute("src", `/data/news/${item.image}`, 0)} class="svelte-ntqhrj"></div>
			<div class="col abstract d-flex flex-column justify-content-around svelte-ntqhrj"><div class="fs-3">${escape(item.title)}</div>
...
//# sourceMappingURL=_page.svelte-28f054bf.js.map
