...
import { P as PageTitle, E as ErrorCard, p as page, n as navigating, g as goto, i as invalidate } from './PageTitle-BekmDxQN.js';
...
const FormFeedback = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.form === void 0 && $$bindings.form && form !== void 0)
    $$bindings.form(form);
  if ($$props.showSuccess === void 0 && $$bindings.showSuccess && showSuccess !== void 0)
    $$bindings.showSuccess(showSuccess);
  return `${form ? `${form.success ? `<div class="alert alert-success alert-dismissable fade show p-2" data-svelte-h="svelte-ajesp3"><div class="row"><div class="col">Config saved!</div> <div class="col-auto d-flex flex-column"><button type="button" class="btn-close" data-bs-dismiss="alert"></button></div></div></div>` : `${showSuccess && form.message ? `${validate_component(ErrorCard, "ErrorCard").$$render($$result, { message: form.message }, {}, {})}` : ``}`}` : ``}`;
});
const CacheTime = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { resultCacheTime = 0 } = $$props;
  let { errorCacheTime = 0 } = $$props;
  if ($$props.resultCacheTime === void 0 && $$bindings.resultCacheTime && resultCacheTime !== void 0)
    $$bindings.resultCacheTime(resultCacheTime);
  if ($$props.errorCacheTime === void 0 && $$bindings.errorCacheTime && errorCacheTime !== void 0)
    $$bindings.errorCacheTime(errorCacheTime);
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$d, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Calendar",
            message: "Unknown action",
...
const Service$c = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Carousel, "Carousel").$$render($$result, { data }, {}, {})}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form, showSuccess: false }, {}, {})} ${validate_component(ServiceConfig$c, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Carousel",
            message: "Unknown action",
...
const Measurement = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { measurement } = $$props;
  if ($$props.measurement === void 0 && $$bindings.measurement && measurement !== void 0)
    $$bindings.measurement(measurement);
...
const Service$b = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Measurement, "Measurement").$$render($$result, { measurement: data.measurement }, {}, {})}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$b, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "DHT sensor",
            message: "Unknown action",
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$a, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Epic Games",
            message: "Unknown action",
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form, showSuccess: false }, {}, {})} ${validate_component(ServiceConfig$9, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Gallery",
            message: "Unknown action",
...
const Service$8 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${action === "icon" ? `${validate_component(Icon$1, "Icon").$$render($$result, { modem: data.info }, {}, {})}` : `${validate_component(Modem, "Modem").$$render($$result, { info: data.info }, {}, {})}`}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$8, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Modem",
            message: "Unknown action",
...
const Service$7 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${action === "icon" ? `${validate_component(Icon, "Icon").$$render($$result, { connected: data.connected }, {}, {})}` : `${validate_component(Interfaces, "Interfaces").$$render($$result, { interfaces: data.interfaces }, {}, {})}`}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$7, "ServiceConfig").$$render($$result, { name, form, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Network",
            message: "Unknown action",
...
const Service$6 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Printer, "Printer").$$render($$result, { job: data.job, printer: data.printer }, {}, {})}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$6, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Prusa",
            message: "Unknown action",
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$5, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "SBB Alerts",
            message: "Unknown action",
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$4, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "SBB Departures",
            message: "Unknown action",
    ...
    {},
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Pagination, "Pagination").$$render(
          ...
          {},
          {}
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$3, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "SRF",
            message: "Unknown action",
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$2, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Swiss Post",
            message: "Unknown action",
...
const Service$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Info, "Info").$$render($$result, { info: data.info }, {}, {})}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$1, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Tuya",
            message: "Unknown action",
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Weather",
            message: "Unknown action",
...
//# sourceMappingURL=services2-BuFritWG.js.map
