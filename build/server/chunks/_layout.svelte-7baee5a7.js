import { c as create_ssr_component, a as subscribe, o as onDestroy, e as escape, b as add_styles } from './index3-53157c6f.js';
import { formatInTimeZone } from 'date-fns-tz';
import { n as navigating } from './stores-08684bc6.js';
import de from 'date-fns/locale/de/index.js';
import { r as reset, p as paused, a as progress } from './screen-eedcf832.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container-fluid vh-100 d-flex flex-column"><div class="row flex-nowrap mb-2 p-1"><div class="col-auto d-flex flex-row align-items-end mt-1 p-0"><div class="time-main svelte-iy2ci2">${escape(timeStr)}</div>
			<div class="time-seconds align-self-stretch d-flex flex-column justify-content-between ms-1 svelte-iy2ci2"><div class="svelte-iy2ci2">${escape(secondStr)}</div>
				<div class="text-muted text-nowrap svelte-iy2ci2">${escape(tzStr)}</div></div></div>

		<div class="col d-flex flex-column justify-content-end align-items-end p-0"><div class="row icons flex-nowrap justify-content-end svelte-iy2ci2">${modem?.operator ? `<div class="col-auto"><i class="icofont-globe"></i>
						${escape(modem.operator.split(" ", 2)[0])}</div>` : ``}

				${modem?.signal ? `<div class="col-auto"><i class="icofont-signal"></i>
						${escape(modem.signal / 4 * 100)}%
					</div>` : ``}

				${modem?.lat && modem?.lng ? `<div class="col-auto"><i class="icofont-satellite"></i>
						${escape(modem.lat.toFixed(0))} | ${escape(modem.lng.toFixed(0))}</div>` : ``}

				${battery ? `<div class="col-auto">${battery.charge > 70 ? `<i class="icofont-battery-full"></i>` : `${battery.charge > 40 ? `<i class="icofont-battery-half"></i>` : `${battery.charge > 10 ? `<i class="icofont-battery-low"></i>` : `<i class="icofont-battery-empty"></i>`}`}`}
						${escape(battery.charge)}%
					</div>` : ``}

				${battery?.state.includes("CHARGING") ? `<div class="col-auto"><i class="icofont-plugin"></i></div>` : ``}
...
//# sourceMappingURL=_layout.svelte-7baee5a7.js.map
