import { c as create_ssr_component, d as each, v as validate_component, e as escape } from './index3-53157c6f.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="h-100 d-flex flex-column justify-content-end">${events.length > 0 ? `${each(events, (event, i) => {
    return `<div class="${[
...
//# sourceMappingURL=_page.svelte-09acba63.js.map
