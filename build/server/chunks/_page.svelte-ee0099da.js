...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  data.prevPage;
  data.nextPage;
  return `<div class="h-100 d-flex flex-column justify-content-end">${alert ? `<div class="row"><div class="col"><div class="card bg-warning border-warning bg-opacity-25"><div class="card-header border-warning fw-bold small d-flex justify-content-between"><div>${escape(formatDescription(alert.description))}</div>
...
//# sourceMappingURL=_page.svelte-ee0099da.js.map
