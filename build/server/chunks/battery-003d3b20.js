...
function getMockStatus() {
  return {
    ...
    powerIn: {
      ...
      current: Math.round(Math.random() * 1e3) / 100 - 5,
      voltage: Math.round(Math.random() * 1e3) / 100 - 5
    },
    powerIn5vIo: {
      state: BatteryPowerState[Math.round(Math.random() * 3)],
      voltage: Math.round(Math.round(Math.random() * 1e3) / 100 - 5),
      current: Math.round(Math.round(Math.random() * 1e3) / 100 - 5)
    },
    fault: {
...
//# sourceMappingURL=battery-003d3b20.js.map
