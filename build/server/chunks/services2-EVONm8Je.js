import { W as WEATHER_SERVICE_TYPE, T as TUYA_SERVICE_TYPE, S as SWISS_POST_SERVICE_TYPE, a as SRF_SERVICE_TYPE, b as SBB_DEPARTURES_SERVICE_TYPE, c as SBB_ALERTS_SERVICE_TYPE, P as PRUSA_SERVICE_TYPE, N as NETWORK_SERVICE_TYPE, M as MODEM_SERVICE_TYPE, G as GALLERY_SERVICE_TYPE, E as EPIC_GAMES_SERVICE_TYPE, D as DHT_SENSOR_SERVICE_TYPE, C as CAROUSEL_SERVICE_TYPE, d as CALENDAR_SERVICE_TYPE, B as BATTERY_SERVICE_TYPE } from './services-BNBgzrtU.js';
import { c as create_ssr_component, v as validate_component, d as escape, o as onDestroy, b as add_attribute, a as subscribe, e as each, f as add_styles, m as missing_component, g as compute_slots, h as assign, i as identity, n as noop } from './ssr-3oCpS140.js';
import { P as PageTitle, E as ErrorCard, p as page, n as navigating } from './PageTitle-CkbP7KuC.js';
import 'perfect-scrollbar';
import './ssr2-CFA0VoKj.js';
import { w as writable, r as readable, D as DEV } from './index-Cjc_Y_rC.js';
...
const FormFeedback = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { form } = $$props;
  let { showSuccess = true } = $$props;
  if ($$props.form === void 0 && $$bindings.form && form !== void 0) $$bindings.form(form);
  if ($$props.showSuccess === void 0 && $$bindings.showSuccess && showSuccess !== void 0) $$bindings.showSuccess(showSuccess);
  return `${form ? `${form.success ? `<div class="alert alert-success alert-dismissable fade show p-2" data-svelte-h="svelte-6snkcb"><div class="row"><div class="col">Success!</div> <div class="col-auto d-flex flex-column"><button type="button" class="btn-close" data-bs-dismiss="alert"></button></div></div></div>` : `${showSuccess && form.message ? `${validate_component(ErrorCard, "ErrorCard").$$render($$result, { message: form.message }, {}, {})}` : ``}`}` : ``}`;
});
const CacheTime = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { resultCacheTime = 0 } = $$props;
  let { errorCacheTime = 0 } = $$props;
  if ($$props.resultCacheTime === void 0 && $$bindings.resultCacheTime && resultCacheTime !== void 0) $$bindings.resultCacheTime(resultCacheTime);
  if ($$props.errorCacheTime === void 0 && $$bindings.errorCacheTime && errorCacheTime !== void 0) $$bindings.errorCacheTime(errorCacheTime);
  return `<div class="row mb-2"><label for="inputResult" class="col-4 col-form-label" data-svelte-h="svelte-1kdxhal">Result cache time (seconds)</label> <div class="col"><input id="inputResult" type="number" name="resultCacheTime" step="any" class="form-control"${add_attribute("value", resultCacheTime, 0)}></div></div> <div class="row mb-2"><label for="inputLat" class="col-4 col-form-label" data-svelte-h="svelte-c0hj2w">Error cache time (seconds)</label> <div class="col"><input id="inputError" type="number" name="errorCacheTime" step="any" class="form-control"${add_attribute("value", errorCacheTime, 0)}></div></div>`;
});
const ServiceConfig$e = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0) $$bindings.data(data);
  return `<ul class="nav nav-tabs" data-svelte-h="svelte-17z7mni"><li class="nav-item me-1"><a href="#general" class="nav-link active" data-bs-toggle="tab">General</a></li> <li class="nav-item me-1"><a href="#cache" class="nav-link" data-bs-toggle="tab">Cache</a></li></ul> <form id="form" method="POST" class="tab-content flex-1 pt-3"><div class="tab-pane container-fluid fade show active" id="general"><div class="row mb-2"><label for="inputBusNumber" class="col-4 col-form-label" data-svelte-h="svelte-1jk0tsg">BUS Number</label> <div class="col"><input id="inputBusNumber" type="number" name="busNumber"${add_attribute("value", data.config.busNumber, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputI2CAddress" class="col-4 col-form-label" data-svelte-h="svelte-vxhugy">I2C Address</label> <div class="col"><input id="inputI2CAddress" type="number" name="i2cAddress"${add_attribute("value", data.config.i2cAddress, 0)} class="form-control"></div></div> <div class="row justify-content-end" data-svelte-h="svelte-3oa9nd"><div class="col-auto"><button type="submit" class="btn btn-theme mt-2">Save</button></div></div></div> <div class="tab-pane container-fluid fade" id="cache">${validate_component(CacheTime, "CacheTime").$$render(
    $$result,
    {
    ...
    {},
    {}
  )} <div class="row justify-content-end" data-svelte-h="svelte-3oa9nd"><div class="col-auto"><button type="submit" class="btn btn-theme mt-2">Save</button></div></div></div></form>`;
});
...
const Service$e = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { name } = $$props;
  let { action } = $$props;
  let { data } = $$props;
  let { form } = $$props;
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${action === "icon" ? `${validate_component(Icon$2, "Icon").$$render($$result, { data }, {}, {})}` : `${validate_component(Battery, "Battery").$$render($$result, { data }, {}, {})}`}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$e, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Battery",
...
const Pagination = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { nextPage } = $$props;
  let { prevPage } = $$props;
  if ($$props.nextPage === void 0 && $$bindings.nextPage && nextPage !== void 0) $$bindings.nextPage(nextPage);
  if ($$props.prevPage === void 0 && $$bindings.prevPage && prevPage !== void 0) $$bindings.prevPage(prevPage);
  $$unsubscribe_page();
...
const ServiceConfig$d = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0) $$bindings.data(data);
  return `<ul class="nav nav-tabs" data-svelte-h="svelte-17z7mni"><li class="nav-item me-1"><a href="#general" class="nav-link active" data-bs-toggle="tab">General</a></li> <li class="nav-item me-1"><a href="#cache" class="nav-link" data-bs-toggle="tab">Cache</a></li></ul> <form id="form" method="POST" class="tab-content flex-1 pt-3"><div class="tab-pane container-fluid fade show active" id="general"><div class="row mb-2"><label for="inputCalendarId" class="col-4 col-form-label" data-svelte-h="svelte-1pibs8m">Calendar ID</label> <div class="col"><input id="inputCalendarId" type="text" name="calendarId"${add_attribute("value", data.config.calendarId, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputServiceEmail" class="col-4 col-form-label" data-svelte-h="svelte-15d8tg5">Service E-Mail</label> <div class="col"><input id="inputServiceEmail" type="text" name="serviceEmail"${add_attribute("value", data.config.serviceEmail, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputPrivateKey" class="col-4 col-form-label" data-svelte-h="svelte-1dvv0qc">Private Key</label> <div class="col"><textarea id="inputPrivateKey" name="privateKey" class="form-control" rows="3">${escape(data.config.privateKey, false)}</textarea></div></div> <div class="row mb-2"><label for="inputItemsPerPage" class="col-4 col-form-label" data-svelte-h="svelte-v4zkg8">Items per page</label> <div class="col"><input id="inputItemsPerPage" type="number" name="itemsPerPage" min="1" max="100" step="1"${add_attribute("value", data.config.itemsPerPage, 0)} class="form-control"></div></div> <div class="row justify-content-end" data-svelte-h="svelte-3oa9nd"><div class="col-auto"><button type="submit" class="btn btn-theme mt-2">Save</button></div></div></div> <div class="tab-pane container-fluid fade" id="cache">${validate_component(CacheTime, "CacheTime").$$render(
    $$result,
    {
      errorCacheTime: data.config.errorCacheTime,
      resultCacheTime: data.config.resultCacheTime
    ...
    {},
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Pagination, "Pagination").$$render(
          ...
          {
            default: () => {
              return `${validate_component(Events, "Events").$$render($$result, { data }, {}, {})}`;
            }
          }
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$d, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Calendar",
            message: "Unknown action",
...
const ServiceConfig$c = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<ul class="nav nav-tabs" data-svelte-h="svelte-1xr13ep"><li class="nav-item me-1"><a href="#screens" class="nav-link active" data-bs-toggle="tab">Screens</a></li> <li class="nav-item me-1"><a href="#icons" class="nav-link" data-bs-toggle="tab">Icons</a></li> <li class="nav-item me-1"><a href="#other" class="nav-link" data-bs-toggle="tab">Other</a></li></ul> <div class="tab-content flex-1 pt-3"><div class="tab-pane container-fluid fade show active" id="screens"><table class="table"><colgroup data-svelte-h="svelte-9pa8eu"><col width="45%"> <col width="45%"> <col></colgroup> <tbody><tr class="bg-dark"><td><select form="formNewScreen" name="service" class="form-select"><option value="" selected disabled data-svelte-h="svelte-1d2mk1m">---</option>${each(services, (service) => {
  ...
  })}</select></td> <td><select form="formNewScreen" name="screenAction" class="form-select"><option value="" data-svelte-h="svelte-dz2bat">---</option>${each(screenActions, (action) => {
    return `<option${add_attribute("value", action, 0)}>${escape(action)}</option>`;
  })}</select></td> <td><form id="formNewScreen" method="POST"><input type="hidden" name="action" value="add_screen"> <button type="submit" class="btn btn-theme" ${"disabled"}><i class="fa-solid fa-plus"></i></button></form></td></tr> ${each(screens, (screen, index) => {
    return `<tr><td>${escape(screen.name)}</td> <td>${escape(screen.action ?? "---")}</td> <td><div class="btn-group"><form method="POST"><input type="hidden" name="action" value="move_screen"> <input type="hidden" name="dir" value="up"> <input type="hidden" name="index"${add_attribute("value", index, 0)}> <button class="${[
      "btn me-2",
      (index > 0 ? "btn-primary" : "") + " " + (index === 0 ? "btn-secondary" : "")
    ].join(" ").trim()}" ${index === 0 ? "disabled" : ""} data-svelte-h="svelte-1gvsfhl"><i class="fa-solid fa-caret-up"></i> </button></form> <form method="POST"><input type="hidden" name="action" value="move_screen"> <input type="hidden" name="dir" value="down"> <input type="hidden" name="index"${add_attribute("value", index, 0)}> <button class="${[
      "btn me-2",
      (index < screens.length - 1 ? "btn-primary" : "") + " " + (index === screens.length - 1 ? "btn-secondary" : "")
    ].join(" ").trim()}" ${index === screens.length - 1 ? "disabled" : ""}><i class="fa-solid fa-caret-down"></i> </button></form> <form method="POST" data-svelte-h="svelte-pb04r4"><input type="hidden" name="action" value="delete_screen"> <input type="hidden" name="index"${add_attribute("value", index, 0)}> <button class="btn btn-danger"><i class="fa-solid fa-trash"></i> </button></form> </div></td> </tr>`;
    ...
    return `<option${add_attribute("value", action, 0)}>${escape(action)}</option>`;
  })}</select></td> <td><form id="formNewIcon" method="POST"><input type="hidden" name="action" value="add_icon"> <button type="submit" class="btn btn-theme" ${"disabled"}><i class="fa-solid fa-plus"></i></button></form></td></tr> ${each(icons, (icon, index) => {
    return `<tr><td>${escape(icon.name)}</td> <td>${escape(icon.action ?? "---")}</td> <td><div class="btn-group"><form method="POST"><input type="hidden" name="action" value="move_icon"> <input type="hidden" name="dir" value="up"> <input type="hidden" name="index"${add_attribute("value", index, 0)}> <button class="${[
      "btn me-2",
      (index > 0 ? "btn-primary" : "") + " " + (index === 0 ? "btn-secondary" : "")
    ].join(" ").trim()}" ${index === 0 ? "disabled" : ""} data-svelte-h="svelte-1gvsfhl"><i class="fa-solid fa-caret-up"></i> </button></form> <form method="POST"><input type="hidden" name="action" value="move_icon"> <input type="hidden" name="dir" value="down"> <input type="hidden" name="index"${add_attribute("value", index, 0)}> <button class="${[
      "btn me-2",
      (index < icons.length - 1 ? "btn-primary" : "") + " " + (index === icons.length - 1 ? "btn-secondary" : "")
    ].join(" ").trim()}" ${index === icons.length - 1 ? "disabled" : ""}><i class="fa-solid fa-caret-down"></i> </button></form> <form method="POST" data-svelte-h="svelte-1xxaqab"><input type="hidden" name="action" value="delete_icon"> <input type="hidden" name="index"${add_attribute("value", index, 0)}> <button class="btn btn-danger"><i class="fa-solid fa-trash"></i> </button></form> </div></td> </tr>`;
  })}</tbody></table></div> <div class="tab-pane container-fluid fade" id="other"><form id="formOther" method="POST" style="display: contents;"><input type="hidden" name="action" value="other"> <div class="row mb-2"><label for="inputCountry" class="col-4 col-form-label" data-svelte-h="svelte-fd8ey">Country</label> <div class="col"><input id="inputCountry" type="text" name="country"${add_attribute("value", data.config.country, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputState" class="col-4 col-form-label" data-svelte-h="svelte-x979eu">State</label> <div class="col"><input id="inputState" type="text" name="state"${add_attribute("value", data.config.state, 0)} class="form-control"></div></div> <div class="row justify-content-end" data-svelte-h="svelte-1fwnvnx"><div class="col-auto"><button type="submit" class="btn btn-theme mt-2">Save</button></div></div></form></div></div>`;
});
...
const Service$c = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Carousel, "Carousel").$$render($$result, { data }, {}, {})}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form, showSuccess: false }, {}, {})} ${validate_component(ServiceConfig$c, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Carousel",
            message: "Unknown action",
...
const ServiceConfig$b = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0) $$bindings.data(data);
  return `<ul class="nav nav-tabs" data-svelte-h="svelte-17z7mni"><li class="nav-item me-1"><a href="#general" class="nav-link active" data-bs-toggle="tab">General</a></li> <li class="nav-item me-1"><a href="#cache" class="nav-link" data-bs-toggle="tab">Cache</a></li></ul> <form id="form" method="POST" class="tab-content flex-1 pt-3"><div class="tab-pane container-fluid fade show active" id="general"><div class="row mb-2"><label for="inputDevicePath" class="col-4 col-form-label" data-svelte-h="svelte-1ig34gq">Device path</label> <div class="col"><input id="inputDevicePath" type="text" name="devicePath"${add_attribute("value", data.config.devicePath, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputDhtPin" class="col-4 col-form-label" data-svelte-h="svelte-11vcmfy">DHT Pin</label> <div class="col"><input id="inputDhtPin" type="number" name="dhtPin" step="1"${add_attribute("value", data.config.dhtPin, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputDhtType" class="col-4 col-form-label" data-svelte-h="svelte-nb5fka">DHT Type</label> <div class="col"><input id="inputDhtType" type="number" name="dhtType" step="1"${add_attribute("value", data.config.dhtType, 0)} class="form-control"></div></div> <div class="row justify-content-end" data-svelte-h="svelte-3oa9nd"><div class="col-auto"><button type="submit" class="btn btn-theme mt-2">Save</button></div></div></div> <div class="tab-pane container-fluid fade" id="cache">${validate_component(CacheTime, "CacheTime").$$render(
    $$result,
    {
      errorCacheTime: data.config.errorCacheTime,
      resultCacheTime: data.config.resultCacheTime
...
const Measurement = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let measurement;
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0) $$bindings.data(data);
  measurement = data.measurement;
  return `<div>${escape(measurement.temp)}°C</div> <div>${escape(measurement.rh)}% RH</div>`;
});
const Service$b = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Measurement, "Measurement").$$render($$result, { data }, {}, {})}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$b, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "DHT sensor",
            message: "Unknown action",
...
const ServiceConfig$a = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0) $$bindings.data(data);
  return `<ul class="nav nav-tabs" data-svelte-h="svelte-17z7mni"><li class="nav-item me-1"><a href="#general" class="nav-link active" data-bs-toggle="tab">General</a></li> <li class="nav-item me-1"><a href="#cache" class="nav-link" data-bs-toggle="tab">Cache</a></li></ul> <form id="form" method="POST" class="tab-content flex-1 pt-3"><div class="tab-pane container-fluid fade show active" id="general"><div class="row mb-2"><label for="inputItemsPerPage" class="col-3 col-form-label" data-svelte-h="svelte-1bipe7b">Items per page</label> <div class="col"><input id="inputItemsPerPage" type="number" name="itemsPerPage" min="1" max="100" step="1"${add_attribute("value", data.config.itemsPerPage, 0)} class="form-control"></div></div> <div class="row justify-content-end" data-svelte-h="svelte-3oa9nd"><div class="col-auto"><button type="submit" class="btn btn-theme mt-2">Save</button></div></div></div> <div class="tab-pane container-fluid fade" id="cache">${validate_component(CacheTime, "CacheTime").$$render(
    $$result,
    {
      errorCacheTime: data.config.errorCacheTime,
      resultCacheTime: data.config.resultCacheTime
    ...
    {},
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Pagination, "Pagination").$$render(
          ...
          {
            default: () => {
              return `${validate_component(Games, "Games").$$render($$result, { data }, {}, {})}`;
            }
          }
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$a, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Epic Games",
            message: "Unknown action",
...
const ServiceConfig$9 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="row overflow-auto"><table class="col table table-sm"><colgroup data-svelte-h="svelte-124xxmx"><col width="10%"> <col width="15%"> <col width="75%"> <col></colgroup> <tbody><tr><td>${`<button class="btn btn-sm w-100" data-svelte-h="svelte-1dqkek5"><i class="fa-solid fa-image fa-xl"></i></button>`} <input type="file" name="newImage" form="formNew" accept=".jpg, .jpeg, .png .mp4" class="svelte-1h3r0r0"${add_styles({ "display": `none` })}></td> <td><input type="date" form="formNew" name="newDate" class="form-control form-control-sm svelte-1h3r0r0"${add_attribute("value", newDate, 0)}></td> <td><input type="text" form="formNew" name="newTitle" class="form-control form-control-sm svelte-1h3r0r0"${add_attribute("value", newTitle, 0)}></td> <td><form id="formNew" method="POST" enctype="multipart/form-data"><input type="hidden" name="action" value="add" class="svelte-1h3r0r0"> <button class="${[
    ...
    ].join(" ").trim()}" ${i === images.length - 1 ? "disabled" : ""}><i class="fa-solid fa-caret-down"></i> </button></form> <form method="POST" data-svelte-h="svelte-1q6lmuc"><input type="hidden" name="action" value="delete" class="svelte-1h3r0r0"> <input type="hidden" name="index"${add_attribute("value", i, 0)} class="svelte-1h3r0r0"> <button class="btn btn-sm btn-outline-danger"><i class="fa-solid fa-trash"></i> </button></form> </div></td> </tr>`;
  })}</tbody></table> </div>`;
});
const css$4 = {
    ...
    {},
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Pagination, "Pagination").$$render(
          ...
          {
            default: () => {
              return `${validate_component(Gallery, "Gallery").$$render($$result, { data }, {}, {})}`;
            }
          }
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form, showSuccess: false }, {}, {})} ${validate_component(ServiceConfig$9, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Gallery",
            message: "Unknown action",
...
const Icon$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0) $$bindings.data(data);
  info = data.info;
  return `${info?.cellular.operator ? `<div class="col-auto"><i class="fa-solid fa-globe"></i> ${escape(info.cellular.operator.split(" ", 2)[0])}</div>` : ``} ${info?.cellular.signal ? `<div class="col-auto"><i class="fa-solid fa-signal"></i> ${escape(info.cellular.signal.toFixed(0))}%</div>` : ``} ${info?.gps ? `<div class="col-auto"><i class="fa-solid fa-satellite"></i> ${escape(info.gps.lat.toFixed(2))} | ${escape(info.gps.lng.toFixed(2))}</div>` : `${info?.geo ? `<div class="col-auto"><i class="fa-solid fa-earth-europe"></i> ${escape(info.geo.lat.toFixed(2))} | ${escape(info.geo.lng.toFixed(2))}</div>` : ``}`}`;
});
const Debug = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0) $$bindings.data(data);
  return `<form id="form" method="POST" class="tab-content flex-1 pt-3" data-svelte-h="svelte-1g3jfi0"><input type="text" name="cmd" placeholder="Command" class="input input-theme"> <button type="submit" class="btn btn-theme btn-sm">Execute</button></form>`;
});
const Service$8 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${action === "icon" ? `${validate_component(Icon$1, "Icon").$$render($$result, { data }, {}, {})}` : `${validate_component(Modem, "Modem").$$render($$result, { data }, {}, {})}`}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$8, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${data.type === "debug" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(Debug, "Debug").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Modem",
            message: "Unknown action",
...
const ServiceConfig$7 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="row overflow-auto"><div class="col mt-2"><div class="row"><h2 class="col" data-svelte-h="svelte-1wh7oxl">WIFIs</h2> <form method="POST" class="col-auto" data-svelte-h="svelte-jkw3e4"><input type="hidden" name="action" value="scan"> <button type="submit" class="btn btn-primary"><i class="fa-solid fa-magnifying-glass"></i></button></form></div> <table class="table table-sm"><colgroup data-svelte-h="svelte-niqyf9"><col width="100%"> <col> <col> <col> <col></colgroup> <thead data-svelte-h="svelte-1gp2fe5"><tr><th>SSID</th> <th>GHz</th> <th>Cha.</th> <th>Sec.</th> <th>Qty</th> <th></th></tr></thead> <tbody>${each(connections, (connection) => {
    return `<tr class="table-active"><td>${escape(connection.ssid)}</td> <td>${escape((connection.frequency / 1e3).toFixed(1))}</td> <td>${escape(connection.channel)}</td> <td>${escape(connection.security)}</td> <td>${escape(connection.quality)}</td> <td><form method="POST"><input type="hidden" name="action" value="disconnect"> <input type="hidden" name="ssid"${add_attribute("value", connection.ssid, 0)}> <button type="submit" class="btn btn-primary" data-svelte-h="svelte-1yzhlyd"><i class="fa-solid fa-link-slash"></i></button> </form></td> </tr>`;
  })} ${each(networks, (network) => {
    return `<tr><td>${escape(network.ssid)}</td> <td>${escape((network.frequency / 1e3).toFixed(1))}</td> <td>${escape(network.channel)}</td> <td>${escape(network.security)}</td> <td>${escape(network.quality)}</td> <td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalWifi" data-svelte-h="svelte-14scr94"><i class="fa-solid fa-link"></i> </button></td> </tr>`;
  })}</tbody></table></div></div> <form method="POST"><div class="modal fade" id="modalWifi" tabindex="-1"><div class="modal-dialog modal-xl"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Connect to ${escape(selectedSSID)}</h5> <button type="button" class="btn-close" data-bs-dismiss="modal"></button></div> <div class="modal-body"><input type="hidden" name="action" value="connect"> <input type="hidden" name="ssid"${add_attribute("value", selectedSSID, 0)}> <input type="password" name="password" placeholder="Password"></div> <div class="modal-footer" data-svelte-h="svelte-1t7f0uu"><button type="button" class="btn btn-default" data-bs-dismiss="modal">Close</button> <button type="submit" class="btn btn-theme" data-bs-dismiss="modal">Connect</button></div></div></div></div></form>`;
});
const Service$7 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${action === "icon" ? `${validate_component(Icon, "Icon").$$render($$result, { data }, {}, {})}` : `${validate_component(Interfaces, "Interfaces").$$render($$result, { data }, {}, {})}`}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$7, "ServiceConfig").$$render($$result, { form, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Network",
            message: "Unknown action",
...
const Service$6 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Printer, "Printer").$$render($$result, { data }, {}, {})}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$6, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Prusa",
            message: "Unknown action",
...
const ServiceConfig$5 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0) $$bindings.data(data);
  return `<ul class="nav nav-tabs" data-svelte-h="svelte-17z7mni"><li class="nav-item me-1"><a href="#general" class="nav-link active" data-bs-toggle="tab">General</a></li> <li class="nav-item me-1"><a href="#cache" class="nav-link" data-bs-toggle="tab">Cache</a></li></ul> <form id="form" method="POST" class="tab-content flex-1 pt-3"><div class="tab-pane container-fluid fade show active" id="general"><div class="row mb-2"><label for="inputApiKey" class="col-3 col-form-label" data-svelte-h="svelte-cnqe5t">API Key</label> <div class="col"><input id="inputApiKey" type="password" name="apiKey"${add_attribute("value", data.config.apiKey ?? "", 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputWords" class="col-3 col-form-label" data-svelte-h="svelte-1lxh57f">Words</label> <div class="col"><textarea id="inputWords" name="words" class="form-control" rows="5">${escape(data.config.words?.join("\n") ?? "", false)}</textarea></div></div> <div class="row justify-content-end" data-svelte-h="svelte-3oa9nd"><div class="col-auto"><button type="submit" class="btn btn-theme mt-2">Save</button></div></div></div> <div class="tab-pane container-fluid fade" id="cache">${validate_component(CacheTime, "CacheTime").$$render(
    $$result,
    {
      errorCacheTime: data.config.errorCacheTime,
      resultCacheTime: data.config.resultCacheTime
    ...
    {},
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Pagination, "Pagination").$$render(
          ...
          {
            default: () => {
              return `${validate_component(Alert, "Alert").$$render($$result, { data }, {}, {})}`;
            }
          }
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$5, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "SBB Alerts",
            message: "Unknown action",
    ...
    {},
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Pagination, "Pagination").$$render(
          ...
          {
            default: () => {
              return `${validate_component(Departures, "Departures").$$render($$result, { data }, {}, {})}`;
            }
          }
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$4, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "SBB Departures",
            message: "Unknown action",
...
const css$3 = {
  code: ".abstract.svelte-1wb7zay.svelte-1wb7zay{font-size:1em;line-height:1.1em}iframe.svelte-1wb7zay.svelte-1wb7zay{width:100%;height:100%;border:1px solid gray}.details.svelte-1wb7zay.svelte-1wb7zay{position:fixed;top:0;left:0;right:0;bottom:0;padding:8px;background-color:rgba(var(--bs-white-rgb), 0.2);z-index:1000}.details.svelte-1wb7zay .btn.svelte-1wb7zay{position:absolute;top:16px;right:16px}.image.svelte-1wb7zay.svelte-1wb7zay{position:relative;overflow:hidden}.image.svelte-1wb7zay img.svelte-1wb7zay{position:absolute;max-width:100%}",
  map: null
};
const News = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${``} <div class="mb-2"></div> ${articles.length > 0 ? `${each(articles, (item) => {
    return `<div role="presentation" class="row mt-1 flex-1"><div class="col-3 me-1 image svelte-1wb7zay"><img alt="Thumbnail"${add_attribute("src", "/" + item.image, 0)} class="h-100 w-100 svelte-1wb7zay" style="object-fit: cover; background-color: red;"></div> <div class="col abstract d-flex flex-column justify-content-around svelte-1wb7zay"><div class="fs-4">${escape(item.title)}</div> <div class="fs-6 text-secondary">${escape(formatDistanceToNow(item.ts, { locale: de$1, addSuffix: true }))} </div></div> </div>`;
  })}` : `${validate_component(EmptyCard, "EmptyCard").$$render($$result, {}, {}, {
    default: () => {
    ...
    {},
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Pagination, "Pagination").$$render(
          ...
          {
            default: () => {
              return `${validate_component(News, "News").$$render($$result, { name, data }, {}, {})}`;
            }
          }
        )}` : `${data.type === "details" ? `${validate_component(Details, "Details").$$render($$result, { data }, {}, {})}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$3, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "SRF",
            message: "Unknown action",
    ...
    {},
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Pagination, "Pagination").$$render(
          ...
          {
            default: () => {
              return `${validate_component(Shipment, "Shipment").$$render($$result, { data }, {}, {})}`;
            }
          }
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$2, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Swiss Post",
            message: "Unknown action",
...
const Service$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Info, "Info").$$render($$result, { data }, {}, {})}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig$1, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Tuya",
            message: "Unknown action",
...
const ServiceConfig = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0) $$bindings.data(data);
  return `<ul class="nav nav-tabs" data-svelte-h="svelte-s11etx"><li class="nav-item me-1"><a href="#general" class="nav-link active" data-bs-toggle="tab">General</a></li> <li class="nav-item me-1"><a href="#modem" class="nav-link" data-bs-toggle="tab">Modem</a></li> <li class="nav-item me-1"><a href="#cache" class="nav-link" data-bs-toggle="tab">Cache</a></li></ul> <form id="form" method="POST" class="tab-content flex-1 pt-3"><div class="tab-pane container-fluid fade show active" id="general"><div class="row mb-2"><label for="inputLat" class="col-4 col-form-label" data-svelte-h="svelte-xau8j7">Latitude</label> <div class="col"><input id="inputLat" type="number" name="lat" step="any"${add_attribute("value", data.config.lat, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputLng" class="col-4 col-form-label" data-svelte-h="svelte-x4c72w">Longitude</label> <div class="col"><input id="inputLng" type="number" name="lng" step="any"${add_attribute("value", data.config.lng, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputMinDiff" class="col-4 col-form-label" data-svelte-h="svelte-ssswlk">Min Diff</label> <div class="col"><input id="inputMinDiff" type="number" name="minDiff"${add_attribute("value", data.config.minDiff, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputApiKey" class="col-4 col-form-label" data-svelte-h="svelte-1vxpm8u">API key</label> <div class="col"><input id="inputApiKey" type="password" name="apiKey"${add_attribute("value", data.config.apiKey, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputGoogleKey" class="col-4 col-form-label" data-svelte-h="svelte-zo3408">Google key</label> <div class="col"><input id="inputGoogleKey" type="password" name="googleKey"${add_attribute("value", data.config.googleKey, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputItemsPerPage" class="col-4 col-form-label" data-svelte-h="svelte-v4zkg8">Items per page</label> <div class="col"><input id="inputItemsPerPage" type="number" name="itemsPerPage" min="1" max="100" step="1"${add_attribute("value", data.config.itemsPerPage, 0)} class="form-control"></div></div> <div class="row justify-content-end" data-svelte-h="svelte-3oa9nd"><div class="col-auto"><button type="submit" class="btn btn-theme mt-2">Save</button></div></div></div> <div class="tab-pane container-fluid fade" id="modem"><div class="row mb-2"><div class="col"><div class="form-check form-switch"><input type="checkbox" name="useGps" class="form-check-input" id="switchUseGps"${add_attribute("checked", useGps, 1)}> <label class="form-check-label" for="switchUseGps" data-svelte-h="svelte-jhwlkj">Use GPS</label></div></div> <div class="col"><div class="form-check form-switch"><input type="checkbox" name="useGeo" class="form-check-input" id="switchUseGeo"${add_attribute("checked", useGeo, 1)}> <label class="form-check-label" for="switchUseGeo" data-svelte-h="svelte-19ng4cx">Use GEO</label></div></div></div> ${useGps || useGeo ? `<div class="row mb-2"><label for="selectModemService" class="col-4 col-form-label" data-svelte-h="svelte-14aqbbp">Modem</label> <div class="col"><select id="selectModemService" name="modemService" class="form-select"${add_attribute("value", data.config.modemService, 0)}>${each(data.modems, (srv) => {
    return `<option${add_attribute("value", srv.name, 0)}>${escape(srv.name)}</option>`;
  })}</select></div></div>` : `<input type="hidden" name="modemService" value="">`} <div class="row justify-content-end" data-svelte-h="svelte-3oa9nd"><div class="col-auto"><button type="submit" class="btn btn-theme mt-2">Save</button></div></div></div> <div class="tab-pane container-fluid fade" id="cache">${validate_component(CacheTime, "CacheTime").$$render(
    $$result,
    {
      errorCacheTime: data.config.errorCacheTime,
      resultCacheTime: data.config.resultCacheTime
...
const Service = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "hourly" ? `${validate_component(Hourly, "Hourly").$$render($$result, { data }, {}, {})}` : `${data.type === "daily" ? `${validate_component(Daily, "Daily").$$render($$result, { data }, {}, {})}` : `${data.type === "alerts" ? `${validate_component(Pagination, "Pagination").$$render(
          $$result,
          {
            prevPage: data.prevPage,
            nextPage: data.nextPage
          ...
          {
            default: () => {
              return `${validate_component(Alerts, "Alerts").$$render($$result, { data }, {}, {})}`;
            }
          }
        )}` : `${data.type === "config" ? `${validate_component(FormFeedback, "FormFeedback").$$render($$result, { form }, {}, {})} ${validate_component(ServiceConfig, "ServiceConfig").$$render($$result, { data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Weather",
            message: "Unknown action",
...
const SERVICES = {
  [BATTERY_SERVICE_TYPE]: Service$e,
  [CALENDAR_SERVICE_TYPE]: Service$d,
  [CAROUSEL_SERVICE_TYPE]: Service$c,
  [DHT_SENSOR_SERVICE_TYPE]: Service$b,
...
//# sourceMappingURL=services2-EVONm8Je.js.map
