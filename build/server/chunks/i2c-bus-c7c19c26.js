import { r as requireBindings, g as getDefaultExportFromCjs } from './bindings-f360734c.js';
...
var i2cBus$2;
var hasRequiredI2cBus;

function requireI2cBus () {
	if (hasRequiredI2cBus) return i2cBus$2;
	hasRequiredI2cBus = 1;

	const fs = require$$0;
	const i2c = requireBindings()('i2c.node');
...
var i2cBusExports = requireI2cBus();
var i2cBus = /*@__PURE__*/getDefaultExportFromCjs(i2cBusExports);

var i2cBus$1 = /*#__PURE__*/_mergeNamespaces({
  __proto__: null,
  default: i2cBus
}, [i2cBusExports]);

export { i2cBus$1 as i };
//# sourceMappingURL=i2c-bus-c7c19c26.js.map
