...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container-fluid vh-100 d-flex flex-column"><div class="row flex-nowrap mb-2 p-1"><div class="col-auto d-flex flex-row align-items-end p-0"><div class="time-main svelte-1hoyhum">${escape(timeStr)}</div>
			<div class="time-seconds ms-1 svelte-1hoyhum">${escape(secondStr)}</div></div>

		<div class="col d-flex flex-column justify-content-start align-items-end overflow-hidden p-0"><div class="row icons flex-nowrap svelte-1hoyhum">${modemStatus?.operator ? `<div class="col-auto"><i class="icofont-globe"></i>
...
//# sourceMappingURL=_layout.svelte-52d782be.js.map
