...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  data.prevPage;
  data.nextPage;
  return `<div class="h-100 d-flex flex-column justify-content-end">${alert ? `<div class="row mh-100"><div class="col mh-100"><div class="card bg-warning border-warning bg-opacity-25 h-100"><div class="card-header border-warning fw-bold small d-flex justify-content-between"><div>${escape(alert.sender)} - ${escape(alert.tags)}</div>
...
//# sourceMappingURL=_page.svelte-81114a8c.js.map
