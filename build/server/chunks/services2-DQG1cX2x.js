...
import { P as PageTitle, E as ErrorCard, p as page, n as navigating, g as goto, i as invalidate } from './PageTitle-B405bhzV.js';
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )}` : `${data.type === "config" ? `${form?.message ? `${validate_component(ErrorCard, "ErrorCard").$$render($$result, { message: form.message }, {}, {})}` : `${form?.success ? `<div class="alert alert-success m-0" data-svelte-h="svelte-1cil5pf">Config saved!</div>` : ``}`} ${validate_component(ServiceConfig$b, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Calendar",
            message: "Unknown action",
...
const ServiceConfig$a = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<ul class="nav nav-tabs" data-svelte-h="svelte-1xr13ep"><li class="nav-item me-1"><a href="#screens" class="nav-link active" data-bs-toggle="tab">Screens</a></li> <li class="nav-item me-1"><a href="#icons" class="nav-link" data-bs-toggle="tab">Icons</a></li> <li class="nav-item me-1"><a href="#other" class="nav-link" data-bs-toggle="tab">Other</a></li></ul> <div class="tab-content flex-1 pt-3"><div class="tab-pane container-fluid fade show active" id="screens"><table class="table"><colgroup data-svelte-h="svelte-9pa8eu"><col width="45%"> <col width="45%"> <col></colgroup> <tbody><tr class="bg-dark"><td><select form="formNewScreen" name="service" class="form-select"><option value="" selected disabled data-svelte-h="svelte-1d2mk1m">---</option>${each(services, (service) => {
  ...
  })}</select></td> <td><form id="formNewScreen" method="POST"><input type="hidden" name="name"${add_attribute("value", name, 0)}> <input type="hidden" name="__formAction" value="add_screen"> <button type="submit" class="btn btn-theme" ${"disabled"}><i class="icofont-ui-add"></i></button></form></td></tr> ${each(screens, (screen, index) => {
    return `<tr><td>${escape(screen.name)}</td> <td>${escape(screen.action ?? "---")}</td> <td><form method="POST"><input type="hidden" name="name"${add_attribute("value", name, 0)}> <input type="hidden" name="__formAction" value="delete_screen"> <input type="hidden" name="index"${add_attribute("value", index, 0)}> <div class="btn-group" data-svelte-h="svelte-1acy9t1"><button class="btn btn-danger"><i class="icofont-ui-delete"></i> </button></div> </form></td> </tr>`;
    ...
    return `<option${add_attribute("value", action, 0)}>${escape(action)}</option>`;
  })}</select></td> <td><form id="formNewIcon" method="POST"><input type="hidden" name="name"${add_attribute("value", name, 0)}> <input type="hidden" name="__formAction" value="add_icon"> <button type="submit" class="btn btn-theme" ${"disabled"}><i class="icofont-ui-add"></i></button></form></td></tr> ${each(icons, (icon, index) => {
    return `<tr><td>${escape(icon.name)}</td> <td>${escape(icon.action ?? "---")}</td> <td><form method="POST"><input type="hidden" name="name"${add_attribute("value", name, 0)}> <input type="hidden" name="__formAction" value="delete_icon"> <input type="hidden" name="index"${add_attribute("value", index, 0)}> <div class="btn-group" data-svelte-h="svelte-1acy9t1"><button class="btn btn-danger"><i class="icofont-ui-delete"></i> </button></div> </form></td> </tr>`;
  })}</tbody></table></div> <div class="tab-pane container-fluid fade" id="other"><form id="formOther" method="POST" style="display: contents;"><input type="hidden" name="name"${add_attribute("value", name, 0)}> <input type="hidden" name="__formAction" value="other"> <div class="row mb-2"><label for="inputCountry" class="col-3 col-form-label" data-svelte-h="svelte-1blm9bf">Country</label> <div class="col"><input id="inputCountry" type="text" name="country"${add_attribute("value", data.config.country, 0)} class="form-control"></div></div> <div class="row mb-2"><label for="inputState" class="col-3 col-form-label" data-svelte-h="svelte-1fam1d7">State</label> <div class="col"><input id="inputState" type="text" name="state"${add_attribute("value", data.config.state, 0)} class="form-control"></div></div> <div class="row justify-content-end" data-svelte-h="svelte-1fwnvnx"><div class="col-auto"><button type="submit" class="btn btn-theme mt-2">Save</button></div></div></form></div></div>`;
});
...
const Service$b = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Carousel, "Carousel").$$render($$result, { data }, {}, {})}` : `${data.type === "config" ? `${form?.message ? `${validate_component(ErrorCard, "ErrorCard").$$render($$result, { message: form.message }, {}, {})}` : ``} ${validate_component(ServiceConfig$a, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Carousel",
            message: "Unknown action",
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )}` : `${data.type === "config" ? `${form?.message ? `${validate_component(ErrorCard, "ErrorCard").$$render($$result, { message: form.message }, {}, {})}` : `${form?.success ? `<div class="alert alert-success m-0" data-svelte-h="svelte-1cil5pf">Config saved!</div>` : ``}`} ${validate_component(ServiceConfig$9, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Epic Games",
            message: "Unknown action",
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {},
    {
      default: () => {
        ...
        )}` : `${data.type === "config" ? `${form?.message ? `${validate_component(ErrorCard, "ErrorCard").$$render($$result, { message: form.message }, {}, {})}` : ``} ${validate_component(ServiceConfig$8, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Gallery",
            message: "Unknown action",
...
const Marker = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="row justify-content-end"><div class="col-auto text-muted"><i class="icofont-location-pin"></i> ${location.place ? `${escape(location.place)}` : `${escape(location.lat)}, ${escape(location.lng)}`}</div></div>`;
});
const css$1 = {
...
const Alerts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.alert === void 0 && $$bindings.alert && alert !== void 0)
    $$bindings.alert(alert);
  $$unsubscribe_tz();
  return `${validate_component(Marker, "Marker").$$render($$result, { location }, {}, {})} <div class="row flex-1"></div> ${alert ? `<div class="row mh-100 overflow-hidden"><div class="col mh-100">${validate_component(Card, "Card").$$render($$result, { type: "warning" }, {}, {
    subTitle: () => {
...
//# sourceMappingURL=services2-DQG1cX2x.js.map
