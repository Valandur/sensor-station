...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="h-100 d-flex flex-column justify-content-between"><div class="row d-flex flex-row justify-content-end"><div class="col-auto text-muted"><i class="icofont-location-pin"></i>
	...
	${alert ? `<div class="row mh-100 overflow-hidden"><div class="col mh-100"><div class="card bg-warning border-warning bg-opacity-25 h-100"><div class="card-header border-warning fw-bold small d-flex justify-content-between"><div>${escape(alert.sender)} - ${escape(alert.tags)}</div>
...
//# sourceMappingURL=_page.svelte-87c81b81.js.map
