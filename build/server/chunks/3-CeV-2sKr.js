import { r as redirect } from './shared-server-C8XaTXK4.js';
...
const actions = {
  restart: async () => {
    exec(
      ...
      (msg) => console.log(
        `${chalk.grey(format(/* @__PURE__ */ new Date(), "HH:mm:ss"))} [${chalk.gray("WARN")}] [${chalk.green("MAIN")}] ${msg}`
      )
    );
  }
};
...
//# sourceMappingURL=3-CeV-2sKr.js.map
