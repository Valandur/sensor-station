...
const Service$e = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Preview$1, "Preview").$$render($$result, { info: data.info }, {}, {})}` : `${data.type === "config" ? `${form?.message ? `${validate_component(ErrorCard, "ErrorCard").$$render($$result, { message: form.message }, {}, {})}` : `${form?.success ? `<div class="alert alert-success m-0" data-svelte-h="svelte-1cil5pf">Config saved!</div>` : ``}`} ${validate_component(ServiceConfig$d, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Battery",
...
const ServiceConfig$b = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="row overflow-auto"><div class="col"><table class="table"><colgroup data-svelte-h="svelte-5pnsju"><col width="50%"> <col width="50%"> <col></colgroup> <tbody><tr><td><select form="formNew" name="service" class="form-select"><option value="" selected disabled data-svelte-h="svelte-1d2mk1m">---</option>${each(services, (service) => {
    return `<option${add_attribute("value", service.name, 0)}>${escape(service.name)} [${escape(service.type.name)}]</option>`;
  })}</select></td> <td><select form="formNew" name="action" class="form-select"><option value="" selected disabled data-svelte-h="svelte-1d2mk1m">---</option>${each(actions, (action) => {
...
const Service$8 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Preview, "Preview").$$render($$result, { info: data.info }, {}, {})}` : `${data.type === "config" ? `${form?.message ? `${validate_component(ErrorCard, "ErrorCard").$$render($$result, { message: form.message }, {}, {})}` : `${form?.success ? `<div class="alert alert-success m-0" data-svelte-h="svelte-1cil5pf">Config saved!</div>` : ``}`} ${validate_component(ServiceConfig$7, "ServiceConfig").$$render($$result, { name, data }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Battery",
            message: "Unknown action",
...
const Service$7 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render(
    ...
    {
      default: () => {
        return `${data ? `${data.type === "data" ? `${validate_component(Interfaces, "Interfaces").$$render($$result, { interfaces: data.interfaces }, {}, {})}` : `${validate_component(ErrorCard, "ErrorCard").$$render(
          $$result,
          {
            title: "Gallery",
            message: "Unknown action",
...
//# sourceMappingURL=services2-D5bAwcvB.js.map
