      ...
      return `<div class="row"><div class="col"><table class="table table-sm"><colgroup><col>
				...
				<tbody><tr><td>Connected</td>
					...
					<tr><td>Operator Time</td>
						<td>${escape(status.time ? format(status.time, "P - p", { locale: de }) : "---")}</td>
						<td>${escape(status.timeTz)}</td></tr>
					<tr><td>GPS Location</td>
						<td>${escape(status.lat)}</td>
						<td>${escape(status.lng)}</td></tr>
					<tr><td>GPS Timezone</td>
						<td>${escape(status.gpsTz)}</td>
...
//# sourceMappingURL=_page.svelte-f726e3a7.js.map
