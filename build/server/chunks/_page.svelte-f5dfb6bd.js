import { c as create_ssr_component, e as escape, d as each, v as validate_component } from './index3-53157c6f.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="h-100 d-flex flex-column justify-content-between"><div class="row d-flex flex-row justify-content-end"><div class="col-auto text-muted"><i class="icofont-location-pin"></i>
			${loc.place ? `${escape(loc.place.name)}, ${escape(loc.place.state)}, ${escape(loc.place.country)}` : `${escape(loc.lat)}, ${escape(loc.lng)}`}</div></div>

	${alert ? `<div class="row mh-100 overflow-hidden"><div class="col mh-100"><div class="card bg-warning border-warning bg-opacity-25 h-100"><div class="card-header border-warning fw-bold small d-flex justify-content-between"><div>${escape(alert.tags)}</div>
...
//# sourceMappingURL=_page.svelte-f5dfb6bd.js.map
