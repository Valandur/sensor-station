...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="h-100 d-flex flex-column justify-content-end">${shipment ? `<div class="row"><div class="col">${validate_component(Card, "Card").$$render($$result, {}, {}, {
    ...
    header: () => {
      return `<div>${escape(shipment.number)}</div> ${shipment.arrival ? `<div><i class="icofont-calendar"></i> ${escape(formatInTimeZone(parseISO(shipment.arrival), data.tz, "dd.MM.yy", { locale: de }))}</div>` : ``} `;
    },
    default: () => {
...
//# sourceMappingURL=_page.svelte-Y6kkn9jf.js.map
