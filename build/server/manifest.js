...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/9-d89a5a6c.js')),
			__memo(() => import('./chunks/10-43020b9f.js')),
			__memo(() => import('./chunks/11-bcb482d4.js')),
			__memo(() => import('./chunks/12-62050206.js')),
			__memo(() => import('./chunks/13-eda83998.js')),
			__memo(() => import('./chunks/14-d823211f.js')),
			__memo(() => import('./chunks/15-0690a884.js')),
			__memo(() => import('./chunks/16-924ebbc9.js')),
			__memo(() => import('./chunks/17-dc5c9985.js')),
			__memo(() => import('./chunks/18-f27cf5e8.js')),
			__memo(() => import('./chunks/19-c1c0c068.js')),
			__memo(() => import('./chunks/20-3c987ded.js')),
			__memo(() => import('./chunks/21-d0a3b2e6.js')),
			__memo(() => import('./chunks/22-5a1ad290.js'))
		],
		routes: [
			{
				id: "/",
